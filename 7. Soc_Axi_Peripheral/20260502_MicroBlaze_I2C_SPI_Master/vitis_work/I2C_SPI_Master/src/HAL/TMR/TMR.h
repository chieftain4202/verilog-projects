...
#if defined(XPAR_TMR_0_S00_AXI_BASEADDR) && defined(XPAR_TMR_1_S00_AXI_BASEADDR) && defined(XPAR_TMR_2_S00_AXI_BASEADDR)
#define TMR_HW_AVAILABLE 1
...
#else
#define TMR_HW_AVAILABLE 0
#define TMR0_BASEADDR 0U
#define TMR1_BASEADDR 0U
#define TMR2_BASEADDR 0U
#endif
